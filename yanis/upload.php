...
<head>
    ...
    <style>
        body {
            ...
            /* Couleur de fond du corps en bleu foncé */
            color: #ffffff;
            /* Couleur du texte du corps en blanc */
        }
    </style>
...
<body>
    ...
    <?php
    $allowed_extensions = ['jpg', 'jpeg', 'png', 'pdf', 'docx']; // Tableau des extensions de fichiers autorisées
    ...
    if (isset($_FILES["profile_pic"])) { // Vérification si un fichier a été soumis via le formulaire
        ...
        if (in_array(pathinfo($_FILES['file']['name'], PATHINFO_EXTENSION), $allowed_extensions)) {
            ...
            echo "<br>";
            echo "Les types de fichiers autorisés sont : jpg, jpeg, png, pdf, word";
            die;
        }
